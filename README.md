...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/imaginer
```

A live public deployment of this template is available at [https://imaginer.templates.workers.dev](https://imaginer.templates.workers.dev)
